...
static void FindCustomer(SQLiteConnection myConnection)
{
    ...
    command.CommandText = $"SELECT customer.rowid AS customerId, customer.firstName, customer.lastName, status.statusType " +
...

    {
        ...
        string readerRowid = reader["customerId"].ToString();
